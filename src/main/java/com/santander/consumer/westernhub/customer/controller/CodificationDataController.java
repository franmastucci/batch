...
@RestController
@Tag(name = "Codification Data", description = "Retrieves and persists codification data")
@Slf4j
public class CodificationDataController {
	...
	/**
	 * Initiates the Codification Data persisting process.
     *
	...
	{
		//ExecutionContext executionContext=ExecutionContext.buildExecutionContext(request);
		LoggingUtils.logControllerInit(log, null/*Constants.METHOD_GET_ALL_REQUEST*/, null);

		String response = dataRetrieverService.retrieveCsvData();
