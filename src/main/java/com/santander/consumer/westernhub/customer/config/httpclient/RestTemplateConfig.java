...
import com.santander.consumer.westernhub.customer.handler.httpclient.CodificationDataClientErrorHandler;
import com.santander.consumer.westernhub.customer.handler.httpclient.CodificationDataClientHttpRequestInterceptor;
...
public class RestTemplateConfig {
    ...
    public RestTemplate restTemplate(@Autowired RestTemplateBuilder restTemplateBuilder) {
        return restTemplateBuilder.requestFactory(this::clientHttpRequestFactory)
                .errorHandler(new CodificationDataClientErrorHandler())
                .interceptors(new CodificationDataClientHttpRequestInterceptor()).build();
    }
